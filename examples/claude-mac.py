...
app = {                # REQUIRED dict, must be named 'app'
    'name' : 'Vibe Coding Mac', # Application name
    'macros' : [       # List of button macros...
        ...
        (0x8000FF, 'Dictate', [Keycode.F5]), # Purple - macOS dictation (set F5 as shortcut in System Settings > Keyboard > Dictation)
        ...
        (0x605000, 'Cost', ['/cost', Keycode.ENTER]),        # Gold
        # 4th row (Utils) ---------------
